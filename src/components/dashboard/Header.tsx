      ...
      <div className="flex items-center justify-between px-4 py-2.5 md:px-6 md:py-3">
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          <div className="flex items-center gap-1.5 rounded-full bg-muted/50 px-2.5 py-1 border border-border/50 md:rounded-lg md:px-3 md:py-2 md:border-border/50">
            ...
            <span className="text-[10px] font-bold text-muted-foreground md:text-xs md:font-medium uppercase">
          ...
          <Button
            ...
            onClick={onRefresh}
            disabled={isPending}
            className="h-8 w-8 text-muted-foreground hover:bg-muted md:h-9 md:w-9 md:border md:border-input"
          >
            <svg
