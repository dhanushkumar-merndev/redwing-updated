          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                <span className="text-[8px] md:text-[10px] font-bold text-muted-foreground">#{applicant.id}</span>
                <span className="text-border/40">/</span>
                <span className="text-[8px] md:text-[10px] font-bold text-muted-foreground truncate uppercase tracking-wider">{applicant.position}</span>
              </div>
            </div>
            <Badge className={cn(
